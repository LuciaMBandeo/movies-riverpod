    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `MovieModel` (`adult` INTEGER NOT NULL, `backdrop` TEXT NOT NULL, `genres` TEXT NOT NULL, `id` INTEGER NOT NULL, `originalLanguage` TEXT NOT NULL, `originalTitle` TEXT NOT NULL, `overview` TEXT NOT NULL, `popularity` REAL NOT NULL, `poster` TEXT NOT NULL, `releaseDate` TEXT NOT NULL, `title` TEXT NOT NULL, `video` INTEGER NOT NULL, `voteAverage` TEXT NOT NULL, `voteCount` INTEGER NOT NULL, `category` TEXT NOT NULL, PRIMARY KEY (`id`))');
        await database.execute(
...
class _$MoviesDao extends MoviesDao {
  ...
  Future<void> insertMovie(MovieModel movie) async {
    await _movieModelInsertionAdapter.insert(movie, OnConflictStrategy.replace);
  }
}
...
class _$GenresDao extends GenresDao {
  ...
  @override
  Future<GenreModel?> fetchGenreById(int id) async {
  ...
  @override
  Future<void> insertGenre(GenreModel movie) async {
    await _genreModelInsertionAdapter.insert(movie, OnConflictStrategy.replace);
  }
}
